        ...
        <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            <div className='flex-1'>
             ...
             >I am an experienced Frontend Developer with over a decade of professional expertise in the field.
                Throughout my career, I have had the privilege of  collaborationg with prestigious organizations,
                contributing to their success and growth.
             </p>

            <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                {infoList.map(({icon, iconDark,title,description}, index)=>(
                      <li className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-poiner hover:bg-lightHover
                ...
                <h4 className='my-6 text-gray-700 font-Ovo dark:text-white/90'>Tools I use</h4>
