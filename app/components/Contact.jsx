...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "55a6990f-14b1-4da4-a382-d9de2110e8e0");
  ...
  return (
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")]
      ...
      <h2 className='text-center md:text-5xl text-4xl font-Ovo'>Get in Touch</h2>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
       ...
       <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
         ...
         <textarea rows='6' placeholder='Enter your message' required className='w-full p-4 outline-none border-[0.5px] 
             border-gray-400 rounded-md bg-white mb-6 dark:bg-darkHover/30 dark:border-white/90' name='message'></textarea>
