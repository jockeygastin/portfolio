...
const Work = () => {
  return (
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <h2 className='text-center md:text-5xl text-4xl font-Ovo'>My Latest Work</h2>

      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
       Welcom to my web development portfolio! Explore a collection of projects showcasing
        my expertise in full-stack developemnt.</p>
         ...
         {workData.map((project, index)=>(
            ...
            className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group' 
             style={{backgroundImage: `url(${project.bgImage})`}}>              
                 ...
                 <div className='border rounded-full border-gray-600 w-9 aspect-square flex items-center justify-center
                             shadow-[2px_2px_0_#000] group-hover:bg-gray-400'>
