...
const Work = (isDarkMode) => {
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <h2 className="text-center md:text-5xl text-4xl font-Ovo">
        My Latest Work
      </h2>
      ...
      <div className="grid grid-cols-auto my-10 gap-5 dark:black text-black">
        {workData.map((project, index) => (
          ...
          >
            ...
            >
              ...
              <a href={project.url}
                className="border rounded-full border-gray-600 w-9 aspect-square flex items-center justify-center
