 ...
 const Navbar = ({isDarkMode, setIsDarkMode}) => {
    ...
    return (
        <>
            ...
            <nav className={` w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex justify-between items-center z-50 $ {isScroll ? "bg-white 
               bg-opacity-50 backdrop-blur-lg shadow-sm  dark:bg-darkTheme dark:shadow-white/20"  : ""}`}
            >
                <a href="#top">

                    <Image alt='logo' src={ isDarkMode ? assets.logo_dark : assets.logo } className='w-28 cursor-pointer mr-14' />
                </a>

                <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "" : `bg-white 
                      shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent`} `}>
                ...
                <div className='flex items-center gap-4'>
                  ...
                  '>Contact <Image alt='arrow' src={ isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} className='w-3'/></a>
